...
describe('Where Are We - Popup', () => {
  describe('Helsinki', () => {
    ...
    it('Shows a popup with no known indigenous territories', () => {
      cy.contains(
        'div',
        'Your IP suggests that you may be in Helsinki, Uusimaa, FI. We cannot find information about indigenous nations at this location, this does not mean that there are not any.'
      )
  ...
  describe('Perth', () => {
    ...
    it('Show a popup with a singular known indigenous territory', () => {
      cy.contains(
        'div',
        'Your IP suggests that you may be on Wajuk country, otherwise known as Perth, Western Australia, AU.'
      )
  ...
  describe('Toronto', () => {
    ...
    it('Show a popup with multiple possible indigenous territories', () => {
      cy.contains(
        'div',
        'Your IP suggests that you may be on Ho-de-no-sau-nee-ga (Haudenosaunee), Anishinabewaki ᐊᓂᔑᓈᐯᐗᑭ, Mississaugas of the Credit First Nation, and/or Mississauga country, otherwise known as Toronto, Ontario, CA.'
      )
